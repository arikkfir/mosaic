...
public class MethodEntry
{
                        ...
                        @Nonnull String[] argumentTypeNames )
    {
        ...
        for( int i = 0; i < argumentTypeNames.length; i++ )
        {
            ...
            {
                throw new IllegalStateException( "Could not find argument type '" + argumentTypeName + "' for declaring method '" + clazz.getName() + "." + methodName + "': " + e.getMessage(), e );
            }
        }
        ...
        {
            throw new IllegalStateException( "Could not find method '" + clazz.getName() + "." + methodName + "': " + e.getMessage(), e );
        }
    }
