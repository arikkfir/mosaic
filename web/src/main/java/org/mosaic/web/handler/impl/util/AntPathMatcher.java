...
public class AntPathMatcher implements PathMatcher
{
    ...
    {
        Splitter splitter = Splitter.on( this.pathSeparator ).omitEmptyStrings();
        if( this.trimTokens )
        {
            splitter = splitter.trimResults();
        }
        String[] patternParts = toArray( splitter.split( pattern ), String.class );
        String[] pathParts = toArray( splitter.split( path ), String.class );
                               ...
                               Map<String, String> uriTemplateVariables )
    {
        ...
        String[] pattDirs = toArray( splitter.split( pattern ), String.class );
        String[] pathDirs = toArray( splitter.split( path ), String.class );
