...
public class MethodEndpointShellCommand implements ShellCommand
{
    ...
    private CommandOption createOption( String parameterName, Class<?> parameterType, Annotation[] parameterAnnotation )
    {
        ...
        if( argsAnn != null )
        {
            ...
            {
                throw new IllegalStateException( "@Args must only be used on String[] or List<String> arguments (" +
                                                 this.name +
                                                 ")" );
            }
        }
