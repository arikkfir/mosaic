...
public interface Requirement {
     ...
     * is already published. In such cases, only that requirement's {@code apply} method is called.
     * <p/>
     ...
     * requirement's {@link #applyInitial(org.springframework.context.ApplicationContext)} method (including the
     ...
     */
    void apply( ApplicationContext applicationContext, Object state ) throws Exception;

    /**
     * Applies requirement usage on the given application context. Usually this means injecting a service to some bean,
     * or registering a service in the OSGi service engine, etc.
     * <p/>
     * Please see {@link #apply(org.springframework.context.ApplicationContext, Object state)} method for details.
     *
     * @param applicationContext the application context of the bundle
     * @throws Exception in case the requirement could not be applied
     */
    void applyInitial( ApplicationContext applicationContext ) throws Exception;

    /**
     * Reverts any changes made on the last {@link #apply(org.springframework.context.ApplicationContext, Object state)}
