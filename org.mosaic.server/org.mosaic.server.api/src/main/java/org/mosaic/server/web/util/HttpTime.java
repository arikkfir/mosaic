package org.mosaic.server.web.util;
...
public abstract class HttpTime
{
    ...
    public static final DateTimeFormatter RFC_1123_DATE_TIME_ZONE_FORMATTER =
    ...
    public static DateTime parse( String httpTime )
    {
        ...
        {
            throw new IllegalArgumentException( "Could not parse HTTP date/time value '" +
                                                httpTime +
